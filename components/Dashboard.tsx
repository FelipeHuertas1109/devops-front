...
export default function Dashboard() {
  ...
  // Definir las tarjetas de directivo - solo las habilitadas en la configuración
  const directivoCards = [
    { id: 0, href: '/directivo/asistencias', title: 'Autorizar Monitores', description: 'Revisar y autorizar asistencias del día', color: 'green', icon: 'M5 13l4 4L19 7', enabled: features.directivo.asistencias.enabled },
    { id: 1, href: '/directivo/horarios', title: 'Ver Horarios', description: 'Consultar todos los horarios de monitores', color: 'blue', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', enabled: features.directivo.horarios.enabled },
    { id: 2, href: '/directivo/reportes', title: '📊 Reportes', description: 'Estadísticas y análisis de asistencias', color: 'purple', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v4', enabled: features.directivo.reportes.enabled },
    { id: 3, href: '/directivo/ajustes-horas', title: 'Ajustes de Horas', description: 'Dar o quitar horas manualmente', color: 'amber', icon: 'M12 8c1.657 0 3-1.343 3-3S13.657 2 12 2 9 3.343 9 5s1.343 3 3 3zm0 2c-2.21 0-4 1.79-4 4v6h8v-6c0-2.21-1.79-4-4-4z', enabled: features.directivo.ajustesHoras.enabled },
    { id: 4, href: '/directivo/heatmap', title: '🗺️ Mapa de Calor', description: 'Visualización anual de asistencias', color: 'pink', icon: 'M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v4', enabled: features.directivo.heatmap.enabled },
    { id: 5, href: '/directivo/finanzas', title: '💰 Finanzas', description: 'Análisis financiero y proyecciones de costos', color: 'emerald', icon: 'M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1', enabled: features.directivo.finanzas.enabled }
  ].filter(card => card.enabled); // Filtrar solo las tarjetas habilitadas
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-6 sm:mb-8">
            {!isDirectivo && features.monitor.horarios.enabled && (
